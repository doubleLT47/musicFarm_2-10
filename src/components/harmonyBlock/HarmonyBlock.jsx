...
const HarmonyBlock = ({ index, isChecked, setVxCheck }) => {
  ...
  const addRow = (option) => {
    if (option === "instrument") {
      const newLenRow = [
        ...lenRow,
        { trackName: "Violin", instrument: "40", vol: "100", note: "48" },
      ];
      setLenRow(newLenRow);
    }
    ...
    if (option === "chord") {
      const newRow = [
        ...lenRow,
        { trackName: "Vocal", instrument: "48", vol: "100", note: "48" },
      ];
      setLenRow(newRow);
    }
    if (option === "fx") {
          ...
          <thead className="trHead">
            ...
            <td className="head6" colSpan="4">
              ...
              <div className="plusIcon">
                <ul>
                  <li onClick={() => addRow("instrument")}>Instrument</li>
                  <li onClick={() => addRow("chord")}>Chord</li>
